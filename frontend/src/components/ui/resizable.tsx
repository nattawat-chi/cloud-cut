/**
 * shadcn/ui resizable — thin wrapper over `react-resizable-panels`.
 * Manually copied (rather than via the shadcn CLI) so the file is auditable
 * and we control the Tailwind classes against our CloudCut theme tokens.
 */
